/**
 * @generated SignedSource<<175acab8eb3366a14cc86f26cd7e3002>>
...
export type SavesPreviewArtworksQuery$variables = {
  collectionID: string;
};
export type SavesPreviewArtworksQuery$data = {
  readonly me: {
    readonly collection: {
...
export type SavesPreviewArtworksQuery = {
  response: SavesPreviewArtworksQuery$data;
  variables: SavesPreviewArtworksQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "SavesPreviewArtworksQuery",
    "selections": [
      {
        "alias": null,
        "args": null,
